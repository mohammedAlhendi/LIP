                  ...
                  children: [
                      ...
                      TextFormFieldWrapper(
                        formField: TextFormField(
                          ...
                          decoration: const InputDecoration(
                              ...
                              prefixIcon: Text("الإيميل"),
                              prefixIconConstraints:
                                  BoxConstraints(minWidth: 0, minHeight: 0),
                              border: InputBorder.none),
                        ),
                      ),
                    if (widget.displayEmail) SizedBox(height: height! * 0.02),
                    const Row(
                      children: [
                        Padding(
                          padding: EdgeInsets.fromLTRB(4, 16, 0, 4),
                          child: Text('معلومات البطاقة'),
                        ),
                      ],
                    ),
                    TextFormFieldWrapper(
                    ...
                    TextFormFieldWrapper(
                      ...
                      formField: TextFormField(
                        ...
                        keyboardType: TextInputType.number,
                        validator: (input) {
                          if (AddressPostalSubmitRegexValidator()
                              .isValid(input!)) {
                            return null;
                          }
                          return 'أدخل رمزًا بريديًا صالحًا';
                        },
                        inputFormatters: [
                          MaskedTextInputFormatter(
                            mask: 'xxxxx',
...
class CardTypeRegs {
  ...
  static final RegExp _mada =
      RegExp(r'^4[0-9]^(5[1-5]|222[1-9]|22[3-9]|2[3-6]|27[01]|2720)[0-9]{0,}$');
  ...
  static CardBrand findBrand(String cardNUmber) {
    ...
    if (_mada.matchAsPrefix(cardNUmber) != null) return CardBrand.mada;
